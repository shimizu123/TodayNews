...
protocol Calculatable {
    ...
    // MARK: 计算宽度
    static func collectionViewWidth(count: Int) -> CGFloat
    // MARK: 计算高度
    static func collectionViewHeight(count: Int) -> CGFloat
    // MARK: 计算 collectionViewCell 的大小
    static func collectionViewCellSize(count: Int) -> CGSize
    // MARK: 计算富文本的高度
    ...
    static func detailCollectionViewCellSize(thumbImages: [ThumbImage]) -> CGSize
    // MARK: 计算详情里的高度
    static func detailCollectionViewHieght(thumbImages: [ThumbImage]) -> CGFloat
}
...
extension Calculatable {
    ...
    static func collectionViewWidth(count: Int) -> CGFloat {
        switch count {
        case 1: return image1Width
        case 2: return (image2Width + 5) * 2
    ...
    static func collectionViewCellSize(count: Int) -> CGSize {
        switch count {
        case 1: return CGSize(width: image1Width, height: image1Width)
   ...
   static func detailCollectionViewCellSize(thumbImages: [ThumbImage]) -> CGSize {
        ...
        case 2, 4: return CGSize(width: image2Width, height: image2Width)

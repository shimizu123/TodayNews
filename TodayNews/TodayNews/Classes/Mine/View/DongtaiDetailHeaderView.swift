...
class DongtaiDetailHeaderView: UIView, NibLoadable {
    ...
    var dongtai = UserDetailDongtai() {
        didSet {
            ...
            case .commentOrQuoteContent, .commentOrQuoteOthers: // 引用或评论
                originThreadView.frame = CGRect(x: 0, y: 0, width: screenWidth, height: dongtai.origin_thread.detailHeight)
    ...
    override func layoutSubviews() {
        ...
        self.height = dongtai.detailHeaderHeight
    }

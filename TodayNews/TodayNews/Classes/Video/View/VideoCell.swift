...
class VideoCell: UITableViewCell, RegisterCellFromNib {
    ...
    var video = NewsModel() {
        didSet {
            ...
            bgImageButton.kf.setImage(with: URL(string: video.video_detail_info.detail_video_large_image.urlString), for: .normal)
            ...
            if video.label_style == .ad {
                ...
                descriptionLabel.text = video.ad_button.description != "" ? video.ad_button.description : video.sub_title
